...
export type TranslationKeys = {
  ...
  "landing.mobileSection.eyebrow": string;
  "landing.mobileSection.title": string;
  "landing.mobileSection.description": string;
  "landing.mobileSection.bullet1": string;
  "landing.mobileSection.bullet2": string;
  "landing.mobileSection.bullet3": string;
  ...
  "auth.resetPassword.password": string;
  "auth.resetPassword.confirm": string;
...
// ─── Calendar ───────────────────────────────────────────────
  ...
  "tradeModal.requiredFieldsError": string;
  "tradeModal.addTradeAria": string;
  "tradeModal.editTradeAria": string;
  "tradeModal.assetClass": string;
  "tradeModal.suggestions": string;
  "tradeModal.cryptoHint": string;
  "tradeModal.forexLotHint": string;
  "tradeModal.multiplierHint": string;
  "tradeModal.positionStatus": string;
  "tradeModal.open": string;
  "tradeModal.closed": string;
  "tradeModal.netPnlPreview": string;
  "tradeModal.fillManually": string;
  "tradeModal.tradeStatus": string;
  "tradeModal.fromPnl": string;
  "tradeModal.pipValue": string;
  "tradeModal.valuePt": string;
  "tradeModal.move": string;
  "tradeModal.setupName": string;
  "tradeModal.setupPlaceholder": string;
  "tradeModal.entryTimeframe": string;
  "tradeModal.selectTimeframe": string;
  "tradeModal.htfTrend": string;
  "tradeModal.selectTrend": string;
  "tradeModal.strategyTag": string;
  "tradeModal.strategyPlaceholder": string;
  "tradeModal.selectEmotion": string;
  "tradeModal.screenshotBefore": string;
  "tradeModal.screenshotDuring": string;
  "tradeModal.screenshotAfter": string;
  "tradeModal.screenshotHint": string;
  "tradeModal.dragDrop": string;
  "tradeModal.placeholder": string;
  "tradeModal.existingScreenshot": string;
  "tradeModal.screenshot": string;
  "tradeModal.existingScreenshotsKept": string;
  "tradeModal.essentialFirst": string;
  "tradeModal.optionalContext": string;
  "tradeModal.emotion.confident": string;
  "tradeModal.emotion.calm": string;
  "tradeModal.emotion.anxious": string;
  "tradeModal.emotion.stressed": string;
  "tradeModal.emotion.fomo": string;
  "tradeModal.emotion.revenge": string;
  "tradeModal.emotion.neutral": string;
  "tradeModal.emotion.enthusiastic": string;
  ...
  // ─── Tutorial ───────────────────────────────────────────────
  "tutorial.btn.back": string;
  "tutorial.btn.close": string;
  "tutorial.btn.last": string;
  "tutorial.btn.next": string;
  "tutorial.btn.open": string;
  "tutorial.btn.skip": string;
  "tutorial.btn.nextWithProgress": string;
  "tutorial.section.title": string;
  "tutorial.section.description": string;
  "tutorial.section.restart": string;
  "tutorial.section.restartAll": string;
  "tutorial.section.resettingAll": string;
  "tutorial.dashboard.welcome": string;
  "tutorial.dashboard.period": string;
  "tutorial.dashboard.kpi": string;
  "tutorial.dashboard.charts": string;
  "tutorial.dashboard.recentTrades": string;
  "tutorial.dashboard.miniCalendar": string;
  "tutorial.calendar.welcome": string;
  "tutorial.calendar.grid": string;
  "tutorial.calendar.actions": string;
  "tutorial.calendar.colors": string;
  "tutorial.calendar.dayClick": string;
  "tutorial.calendar.import": string;
  "tutorial.journal.welcome": string;
  "tutorial.journal.list": string;
  "tutorial.journal.newEntry": string;
  "tutorial.journal.entryContent": string;
  "tutorial.journal.tradeReview": string;
  "tutorial.stats.welcome": string;
  "tutorial.stats.metrics": string;
  "tutorial.stats.breakdown": string;
  "tutorial.stats.distribution": string;
  "tutorial.stats.metricsDetail": string;
  "tutorial.stats.breakdownFilters": string;
  "tutorial.stats.distributionModes": string;
  "tutorial.comptes.welcome": string;
  "tutorial.comptes.list": string;
  "tutorial.comptes.add": string;
  "tutorial.comptes.details": string;
  "tutorial.comptes.switch": string;
  "tutorial.profil.welcome": string;
  "tutorial.profil.identity": string;
  "tutorial.profil.overview": string;
  "tutorial.profil.tutorials": string;
  "tutorial.tradeDetail.welcome": string;
  "tutorial.tradeDetail.hero": string;
  "tutorial.tradeDetail.badges": string;
  "tutorial.tradeDetail.execution": string;
  "tutorial.tradeDetail.chart": string;
  "tutorial.tradeDetail.context": string;
  "tutorial.tradeDetail.confluences": string;
  "tutorial.tradeDetail.psychology": string;
